  ...
  return (
    <header className="fixed h-80 w-full border-b bg-white">
      <div className="mx-auto flex h-full max-w-1200 items-center justify-between">
        <BuilDoneLogo />
        <button className="rounded-8 border border-dark-blue-500 px-12 py-10 text-16 font-bold text-dark-blue-500 transition-colors delay-75 hover:bg-dark-blue-500 hover:text-white">
          로그인/회원가입
        </button>
      </div>
    </header>
